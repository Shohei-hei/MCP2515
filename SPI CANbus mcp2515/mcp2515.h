...
//ボーレート設定　8MHz
#define CAN_BRP_8MHZ_500KBRS 0
#define CAN_BRP_8MHZ_125KBPS 1
//受信バッファ動作モード
...
//------------------------------------------------------------------------------
//CANオペレーションモード設定
#define CANSetOpMode(mode) CANBitModCmd(CAN_ADRS_CANCTRL,0xE0,mode)
//ボーレート設定
...
//SPIポートの操作定義
#define CAN_SPI_CS RA5
#define CAN_SPI_SO RC5
#define CAN_SPI_SCK RC3

#define CAN_SPI_SI RC4
